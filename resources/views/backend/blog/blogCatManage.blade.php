...
<h3 class="text-center text-primary"> {{Session::get('message')}}</h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              {!!Form::open(['route' =>'blogCatSave','method'=>'post','class'=>'form-horizontal','name'=>'editAboutForm'])!!}
              <div class="box-body">
        ...
        <div class="modal fade" id="modal-default{{$category->id}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
              {!!Form::open(['route' =>'blogCatUpdate','method'=>'post','class'=>'form-horizontal','name'=>'editAboutForm'])!!}
              <div class="box-body">
          ...
          {!!Form::close()!!}
            ...
            <!-- /.modal-content -->
                ...
                <a href="{{route('blogCatDelete',$category->id)}}"  onclick="return confirm('Are you sure to delete this');"><span class="label label-danger">Delete</span></a>
				  </td>
                </tr>
