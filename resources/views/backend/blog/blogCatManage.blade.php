    ...
    <div class="row">
      <div class="col-md-10">
        ...
        <div class="box box-primary">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  {!!Form::open(['route'
                  =>'blogCatSave','method'=>'post','class'=>'form-horizontal','name'=>'editAboutForm'])!!}
                  <div class="box-body">
          ...
          <a href="" data-toggle="modal" data-target="#modal-default{{$category->id}}"><span
          ...
          <div class="modal fade" id="modal-default{{$category->id}}">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  {!!Form::open(['route'
                  =>'blogCatUpdate','method'=>'post','class'=>'form-horizontal','name'=>'editAboutForm'])!!}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{$category->category}}" class="form-control" id="exampleInputEmail1"
                        name="category">
          ...
          <a href="{{route('blogCatDelete',$category->id)}}"
            onclick="return confirm('Are you sure to delete this');"><span class="label label-danger">Delete</span></a>
          </td>
          </tr>
