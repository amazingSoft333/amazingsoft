        ...
        <div class="col-md-10">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Home About Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              {!!Form::open(['route' =>'homeAboutUpdate','method'=>'post','class'=>'form-horizontal','name'=>'editAboutForm'])!!}
              <div class="box-body">
          ...
          {!!Form::close()!!}
            ...
            <!-- /.modal-content -->
                ...
                <a href="{{route('homeAboutDelete',$des->id)}}"  onclick="return confirm('Are you sure to delete this');"><span class="label label-danger">Delete</span></a>
				  </td>
                </tr>
                @endforeach
